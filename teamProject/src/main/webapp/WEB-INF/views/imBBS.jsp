...
<table border="1" width="100%" height="40" id="tab2">
	<tr align="center">
		<td width="33%"><a href="adminBasic_1.html">구입</a></td>
		<td width="33%" style="background-color:#853fd3;"><a href="adminBasic_2.html">반품</a></td>
   ...
   <ul id="list">
   		<li class="a1">24</li>
   		<li class="a2"><span style="display:inline-block;background-color:#853fd3;width:70px;height:20px;border-radius:10px;font-size:12px;text-align:center;line-height:20px;color:white;margin-right:10px">반품</span>  국립오페라</li>
   		<li class="a3">여태</li>

...
<div class="box7">
	<div class="box7-1">
		<img src="/webApp/img/brazil-single.jpg">
	</div>
	<div class="box7-2">
		<h1>BRAZIL</h1>
		<ul>
			<li class="left">원산지</li>
			<li class="right">	Brazil</li>
			<li class="left">판매가</li>
			<li class="right">4,000원</li>
			<li class="left">Blending</li>
			<li class="right">브라질</li>
			<li class="left">BRAZIL [200g]</li>

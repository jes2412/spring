...
<div class="box7">
	<div class="box7-1">
		<img src="/webApp/img/cokein-single.jpg">
	</div>
	<div class="box7-2">
		<h1>COKEIN</h1>
		<ul>
			<li class="left">원산지</li>
			<li class="right">	Colombia, Costa Rica, Kenya...</li>
			<li class="left">판매가</li>
			<li class="right">5,500원</li>
			<li class="left">Blending</li>
			<li class="right">콜롬비아 코스타리카 케냐 인도네시아만델링</li>
			<li class="left">COKEIN [200g]</li>

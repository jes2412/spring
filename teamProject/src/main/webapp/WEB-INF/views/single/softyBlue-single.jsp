...
<div class="box7">
	<div class="box7-1">
		<img src="/webApp/img/softyBlue-single.jpg">
	</div>
	<div class="box7-2">
		<h1>SOFTY BLUE</h1>
		<ul>
			<li class="left">원산지</li>
			<li class="right">	Brazil, Colombia, Ethiopia...</li>
			<li class="left">판매가</li>
			<li class="right">5,000원</li>
			<li class="left">Blending</li>
			<li class="right">브라질 콜롬비아 과테말라 에티오피아</li>
			<li class="left">SOFTY BLUE [200g]</li>

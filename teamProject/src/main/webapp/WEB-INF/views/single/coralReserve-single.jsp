...
<div class="box7">
	<div class="box7-1">
		<img src="/webApp/img/coralReserve-single.jpg">
	</div>
	<div class="box7-2">
		<h1>CORAL RESERVE</h1>
		<ul>
			<li class="left">원산지</li>
			<li class="right">	Colombia, Brazil, Costa Rica</li>
			<li class="left">판매가</li>
			<li class="right">10,000원</li>
			<li class="left">Blending</li>
			<li class="right">브라질 콜롬비아 코스타리카</li>
			<li class="left">CORAL RESERVE [200g]</li>

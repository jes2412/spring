...
<div class="box7">
	<div class="box7-1">
		<img src="/webApp/img/cayenne-single.jpg">
	</div>
	<div class="box7-2">
		<h1>CAYENNE</h1>
		<ul>
			<li class="left">원산지</li>
			<li class="right">	Indonesia, Papua New Guinea</li>
			<li class="left">판매가</li>
			<li class="right">7,700원</li>
			<li class="left">Blending</li>
			<li class="right">인도네시아 파푸아뉴기니</li>
			<li class="left">CAYENNE [200g]</li>

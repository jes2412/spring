...
<div class="box7">
	<div class="box7-1">
		<img src="/webApp/img/roasted-single.jpg">
	</div>
	<div class="box7-2">
		<h1>ROASTED</h1>
		<ul>
			<li class="left">원산지</li>
			<li class="right">	Brazil, Guatemala, Vietnam</li>
			<li class="left">판매가</li>
			<li class="right">4,400원</li>
			<li class="left">Blending</li>
			<li class="right">브라질 과테말라 베트남</li>
			<li class="left">ROASTED [200g]</li>

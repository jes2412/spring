...
<div class="box7">
	<div class="box7-1">
		<img src="/webApp/img/deepPurple-single.jpg">
	</div>
	<div class="box7-2">
		<h1>DEEP PURPLE</h1>
		<ul>
			<li class="left">원산지</li>
			<li class="right">	Brazil, Colombia, tanzania..</li>
			<li class="left">판매가</li>
			<li class="right">5,000원</li>
			<li class="left">Blending</li>
			<li class="right">브라질 콜롬비아 탄자니아 만델링</li>
			<li class="left">DEEP PURPLE [200g]</li>

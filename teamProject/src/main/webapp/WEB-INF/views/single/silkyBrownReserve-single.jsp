...
<div class="box7">
	<div class="box7-1">
		<img src="/webApp/img/silkyBrownReserve-single.jpg">
	</div>
	<div class="box7-2">
		<h1>SILKY BROWN RESERVE</h1>
		<ul>
			<li class="left">원산지</li>
			<li class="right">	Colombia, Guatemala...</li>
			<li class="left">판매가</li>
			<li class="right">11,000원</li>
			<li class="left">Blending</li>
			<li class="right">콜롬비아 과테말라 코스타리카</li>
			<li class="left">SILKY BROWN RESERVE [200g]</li>

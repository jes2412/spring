...
<table style="background-color:#eeeeee" width="100%" height="40" id="tab">
  ...
  <c:if test="${vo.category!='community' && vo.category!='notice'}">
   		<li class="a1">뺄거</li>
   		<li class="a2"><span style="display:inline-block;background-color:#8dd33f;width:70px;height:20px;border-radius:10px;font-size:12px;text-align:center;line-height:20px;color:white;margin-right:10px">1:1문의</span><a href="/webApp/view?num=${vo.bbsNum}">${vo.title}</a></li>
	...
	<span id="write"><a href="/webApp/write?category=1:1문의">글쓰기</a></span>
 </div>
</div>

...
<table border="1" width="100%" height="40" id="tab2">
	<tr align="center">
		<td width="33%"><a href="">구입</a></td>
		<td width="33%" ><a href="">반품</a></td>
		<td width="33%"><a href="">루루루</a></td>
	</tr>	
</table><br/>
   <ul id="head">
   		<li class="a1">번호</li>
   ...
   <ul id="list">
   		<li class="a1">24</li>
   		<li class="a2"><span style="display:inline-block;background-color:#ed95b7;width:70px;height:20px;border-radius:10px;font-size:12px;text-align:center;line-height:20px;color:white;margin-right:10px">1:1문의</span>  국립오페라</li>
   		<li class="a3">여태</li>
